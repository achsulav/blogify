...
class Application
{
    ...
    public function getSubdomain(): ?string
    {
        ...
        // Ignore IP addresses, localhost, and production domains (since they have 3+ parts but no wildcard subdomains on free tier)
        if (is_production() || filter_var($host, FILTER_VALIDATE_IP) || $host === 'localhost') {
            return null;
        }
